...
import { BufferAttribute, BufferGeometry, Mesh as ThreeMesh, MeshPhongMaterial, PerspectiveCamera, Scene, WebGLRenderer, GridHelper, AxesHelper } from 'three';
...
export function setupPreview(canvas: HTMLCanvasElement, onParamsChange?: (params: BracketParams) => void) {
    ...
    const gridHelper = new GridHelper(200, 20, 0x444444, 0x222222);
